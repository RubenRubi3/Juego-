...
function Character() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/carmena.jpg";
 ...
 this.update = function () {
  if (keyboard.getPressed() == ' ') {
   this.image.src = "Imagenes/carmena.jpg";
...
function Kamehameha() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/pistola.jpg";
...
function Shot() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/leche.jpg";
